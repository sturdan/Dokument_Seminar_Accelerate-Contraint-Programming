\begin{titlepage}
  ...
  \begin{abstract}
    ...
    Die Bemühungen zur Beschleunigung von CP-Systemen bieten vielfältige
    Strategien, wobei deren Wirksamkeit stark von den spezifischen
    Problemstellungen abhängt. Die laufende Forschung verspricht weitere
    Verbesserungen, die möglicherweise von aufkommenden Technologien wie der
    Quantencomputing beeinflusst werden.
  \end{abstract}
